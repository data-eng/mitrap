...
conc_cc = pandas.DataFrame( df["BC6[ng/m3]"]/1000 ).rename( {"BC6[ng/m3]":"concentration_cc"}, axis=1  )

new_df = pandas.concat( [datetime.to_frame(name="datetime"), stn_df, ins_df, conc_cc, df], axis=1 )
