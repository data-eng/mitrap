...
python3 ${BINDIR}/raw.py "${file_to_process}" "${file_to_store}.temp1" "${station_name}" "${instrument_name}" "${instrument_tz}"

python3 ${BINDIR}/pm_lp_maker.py "${file_to_store}.temp1" > "${file_to_store}.lp"
