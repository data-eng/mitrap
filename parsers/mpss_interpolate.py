...
if num_target_diam == -1:
    ...
    elif target_setting == "peretola32":
        target_diam = numpy.array( [9.838,10.359,11.489,12.744,14.138,15.688,17.412,19.329,21.465,23.843,26.495,29.454,32.759,36.454,40.589,45.225,50.43,56.284,62.881,70.334,78.775,88.364,99.295,111.802,126.174,142.764,162.016,184.478,210.838,241.956,278.91,300.004] )
    else:
        target_diam = None
else:
