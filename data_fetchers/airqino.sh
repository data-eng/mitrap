...
curl --location "https://airqino-api.magentalab.it/getHourlyAvg/${AIRQINO_STATION}/${DATE1}/${DATE2}" --header "Authorization: Bearer ${TOKEN}" -s -o "/mnt/web/airqino/raw/${MYTIMESTAMP}.txt" 
